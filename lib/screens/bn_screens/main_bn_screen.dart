...
class _MainBnScreenState extends State<MainBnScreen>
  ...
  List<Product> womanProducts = [
    ...
    Product(
        id: 10,
        image: 'images/fashion_6.jpg',
        title: 'Classic hoodie',
        subTitle: 'new brand',
        price: '300'),
    Product(
        id: 10,
        image: 'images/fashion_7.jpg',
        title: 'Classic hoodie',
        subTitle: 'new brand',
        price: '100'),
  ];
            ...
            child: GridView.builder(
              ...
              itemBuilder: (context, index) {
                return ProductCard(
                  ...
                  subTitle: menProducts[index].subTitle,
            ...
            child: GridView.builder(
              ...
              itemBuilder: (context, index) {
                return ProductCard(
                  ...
                  image: womanProducts[index].image,
                  title: womanProducts[index].title,
                  subTitle: womanProducts[index].subTitle,
